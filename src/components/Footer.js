        ...
        <>
            <Card className="text-center">
                ...
                <Card.Body>
                    ...
                    <Card.Text>
                        <a href="https://github.com/AndrewbHall96" target="_blank" rel="noopener noreferrer">
                            <i class="fa fa-github pr-2 fa-2x" aria-hidden="true"></i>
                        </a>
                        <a href="https://www.linkedin.com/in/andrew-hall-248798171/" target="_blank" rel="noopener noreferrer">
